/*  Program: binary_search.cpp
    ...
    Class: CSCI 140
    Date: 10/17/18
    Description: A program that implements and runs binary search.
...
int main()
{
    ...
    int arrayAsc[] ={0,2,2,3,5,9,11,12,12,12,13,17,18,19,19,34};

    cout << "Enter an integer to search for:" << endl;
    cin >> value;

    found = binarySearch(arrayAsc, SIZE, value); //function call to perform the binary search
